...
class CyberData(): 
    ...
    def _prep_txns_set(self, path):
        # SHAREPOINT:/MotorDeCobranza/Documentos%20compartidos/2%20Cobranza/Cyber/TransactionTypes.xlsx
        # Quitar '092703'
        txn_codes = [92800, 500027, 550021, 550022, 550023, 550024, 550403, 550908, 
    ...
    def fxw_converter(self, specs_df:pd_DF) -> dict: 
        ...
        str_λs = {
            'str' : compose(packed(F.format_string), ɣ('c_format', 'nombre')), 
